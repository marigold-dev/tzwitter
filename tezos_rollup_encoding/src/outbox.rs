...
mod test {
    ...
    const ENCODED_TRANSACTION_ONE: [u8; 74] = [
        007, 007, // Prim pair tags
        // Contract KT1 hash
        b'\n', 000, 000, 000, 022, 001, 209, 163, b'|', 8, 138, 018, b'!', 182, b'6', 187,
        b'_', 204, 179, b'^', 005, 024, 016, b'8', 186, b'|', 000, // Padding
        007, 007, // Prim pair tags,
        // String
        001, // tag
        000, 000, 000, 003, // size,
        b'r', b'e', b'd', // contents,
        000, 001, // nat size + value
        // Destination
        001, // originated tag
        ...
        0,  // padding
        //  entrypoint
        000, 000, 000, 007, b'd', b'e', b'f', b'a', b'u', b'l', b't',
    ];
    ...
    const ENCODED_TRANSACTION_TWO: [u8; 78] = [
        ...
        007, 007, // prim pair tags
        // Contract KT1 hash
        b'\n', 000, 000, 000, 022, 001, b'$', b'f', b'g', 169, b'1', 254, 011, 210, 251,
        028, 182, 004, 247, 020, b'`', 030, 136, b'(', b'E', b'P', 000, // padding
        007, 007, // prim pair tags
        // String contents
        001, 000, 000, 000, 006, b'y', b'e', b'l', b'l', b'o', b'w', // end contents
        000,  // Nat tag
        137, 005, // Z(329)
        // Destination
        001, 021, 237, 173, b'\'', 159, b'U', 226, 254, b'@', 017, 222, b'm', b',', b'$',
        253, 245, 027, 242, b'%', 197, 000, // Entrypoint
        000, 000, 000, 007, // Entrypoint size
