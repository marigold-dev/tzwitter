import { blake2b, blake2bHex, blake2s, blake2sHex } from "blakejs";
...
class Tzwitter {
    ...
    constructor({ signer, tezosUrl, rollupUrl, magicByte, verbose }: { signer: Signer, tezosUrl: string, rollupUrl: string, magicByte?: string, verbose?: boolean }) {
        this.signer = signer;
        this.rollupClient = new RollupClient({ signer, tezosUrl, rollupUrl, verbose });
