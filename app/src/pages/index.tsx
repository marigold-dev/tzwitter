...
const tzwitterClient = new Tzwitter({ signer, tezosUrl: TEZOS_URL, rollupUrl: ROLLUP_URL, verbose: true });

const Index = () => {
  const [account, setAccount] = useState<AccountType | undefined>();
  const [tzwitter, setTzwitter] = useState<Tzwitter>(tzwitterClient);
